Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency 'rest-client', '~> 2.1.0', '>= 1.8.0'
  s.add_runtime_dependency 'liquid', '~> 3.0', '>= 3.0.6'

  s.required_ruby_version = '>= 2.0'
  s.require_paths = ['.']
  s.authors     = ['Jakub Hozak', 'Jose Galisteo', 'Maria Pilar Guerra Arias', 'Andrew Mackenzie', 'Daria Mayorova','Hugo Guerrero']
